...
// Jump from water
if (key_jump) && (place_meeting(x, y-3, obj_water) )
{
	//show_debug_message("Waterjumps");
...
if (state == playerState.jumping && vsp > 0)
{
