...
if (place_meeting(x, y, obj_player))
{
	...
	if (obj_player.y < y-16)
	{
		...
		if !audio_is_playing(snd_enemy_death) && !audio_is_playing(snd_mini_jump)
		{
